export const commandNames = {
  ...
  closeItemTab: '単体のタブを閉じる',
  closeSubtreeTabs: 'ツリーのタブを閉じる',
  discardItemTab: '単体をdiscard',
  discardSubtreeTabs: 'ツリーをdiscard',
  openItemTab: '単体のタブをバックグラウンドで開く',
  openSubtreeTabs: 'ツリーをタブをバックグラウンドで開く',
  browseTab: 'ウェブページを閲覧',
