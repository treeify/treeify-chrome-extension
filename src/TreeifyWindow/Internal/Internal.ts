  ...
  static createInitialState(): State {
    return {
      ...
      itemTreeKeyboardBinding: {
        ...
        '1000ArrowUp': {functionName: 'moveItemToPrevSibling'},
        '1000ArrowDown': {functionName: 'moveItemToNextSibling'},
        '1100ArrowUp': {functionName: 'moveItemUpward'},
        '1100ArrowDown': {functionName: 'moveItemDownward'},
        ...
        '1000KeyD': {functionName: 'removeEdge'},
      ...
      itemTreeDeleteButtonMouseBinding: {
        '0000MouseButton0': {functionName: 'removeEdge'},
